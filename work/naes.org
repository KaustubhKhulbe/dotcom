...
#+begin_quote
*Note:* This is a port of a page on my old website. It may not be synced with current progress.
#+end_quote
...
#+begin_horizbullets
- [[../static/naes.pdf][ Report]]
- [[https://github.com/pradyungn/NaES][GitHub]]
#+end_horizbullets
